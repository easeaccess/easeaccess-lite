// Navigation App - Same functionality as App.jsx but without draggable/positioning features
...
const NavApp = () => {
	...
	if (!svgSettings?.navMode) return null; // Only show in nav mode
	...
	// Navigation mode - inline display for menu integration
	return (
		<div
			className="zn:inline-block zn:!font-sans"
			id="accessibility-widget-nav-component"
		>
			{isPopover ? (
				<Popover
				...
				>
					<PopoverTrigger asChild>
						<button className="zn:!bg-transparent zn:!p-2 zn:!border-0 zn:cursor-pointer">
					...
					<PopoverContent
						...
						className={cn(
							...
							{
								"zn:md:w-[490px] zn:w-full": containerTheme === "default",
